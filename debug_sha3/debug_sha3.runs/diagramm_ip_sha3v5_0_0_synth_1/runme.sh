...
HD_PWD='/home/anzhelika/projekt/diplom/debug_progectv5/debug_sha3/debug_sha3.runs/diagramm_ip_sha3v5_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log diagramm_ip_sha3v5_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source diagramm_ip_sha3v5_0_0.tcl
